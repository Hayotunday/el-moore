    ...
    <div className="relative flex flex-col items-center justify-center overflow-x-hidden">
      ...
      >
        ...
        >
          ...
          <motion.div
            className="flex flex-col sm:flex-row items-stretch sm:items-center gap-0 glass rounded-full overflow-hidden shadow-ambient-lg max-w-2xl ring-1 ring-white/20 p-1.5"
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.4, ease: [0.16, 1, 0.3, 1] }}
          >
            <div className="flex-1 px-5 py-2.5 border-b sm:border-b-0 sm:border-r border-white/15">
            ...
            <Link
              href="/listings"
              className="rounded-full bg-gold text-secondary-foreground px-8 py-3.5 text-xs font-bold uppercase tracking-wider hover:bg-gold/90 transition-colors flex items-center justify-center gap-2 whitespace-nowrap active:scale-[0.97]"
            >
      ...
      <section className="w-full bg-primary border-t border-white/10">
        <div className="container grid grid-cols-2 sm:grid-cols-4 gap-4 py-10">
          {[
            ...
            <div
              key={stat.label}
              className="glass rounded-3xl ring-1 ring-white/10 flex flex-col items-center text-center gap-1 py-6 px-3 text-primary-foreground"
            >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
              <ScrollReveal delay={0.1}>
                <div className="rounded-3xl bg-card p-7 space-y-3 shadow-ambient ring-1 ring-border/60">
              ...
              <ScrollReveal delay={0.2}>
                <div className="rounded-3xl bg-gold p-7 text-secondary-foreground space-y-3">
                  ...
                  <Link
                    href="/calculator"
                    className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider bg-background/10 border border-background/20 px-4 py-2 rounded-full hover:bg-background/20 transition-colors"
                  >
                    Calculate Now
                  </Link>
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <ScrollReveal direction="left">
              <div className="grid grid-cols-2 gap-3">
                <div className="rounded-[2rem] overflow-hidden aspect-3/4 ring-1 ring-white/10">
                  <img
                ...
                <div className="space-y-3">
                  <div className="rounded-3xl glass ring-1 ring-white/15 p-5 text-white">
                    <p className="text-xs font-bold">Legal Masterclass</p>
                    <p className="text-xs opacity-70 mt-1">
                      Understanding Land Use Act implications for investors.
                    </p>
                  </div>
                  <div className="rounded-[2rem] overflow-hidden aspect-square ring-1 ring-white/10">
                    <img
            ...
            <ScrollReveal direction="right">
              ...
              <Link
                href="/blog"
                className="inline-flex items-center gap-2 border border-white/50 text-white rounded-full px-6 py-3 text-xs font-bold uppercase tracking-wider hover:bg-gold hover:border-gold hover:text-secondary-foreground transition-colors active:scale-[0.97]"
              >
                Enter the Academy
              </Link>
            </ScrollReveal>
